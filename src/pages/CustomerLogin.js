    ...
    <div >
      <div className="bg-slate-200 md:h-96 md:w-2/3 -mt-2 md:border-2 md:border-gray md:ml-48 md:mt-14 md:mb-24 md:shadow-lg">
        ...
        <form onSubmit={handleLogin}>
          <input className="border-2 border-gray-400 w-96 ml-28 mt-2 rounded-md p-1"
            type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required />
          <br />
          <input className="border-2 border-gray-400 w-96 mt-2 ml-28 rounded-md p-1"
            type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} required />
          <br /><br />
          <button className="border-2 border-gray-500 w-32 ml-60 mb-10 hover:text-black rounded-md" type="submit"> Login </button>
        </form>
