  ...
  return (
    <div>
         ...
         <div className='flex h-10 w-full p-1 mb-20 border-t-2 border-b-2'>
          <div className="text-center font-semibold mx-auto hidden md:block ">{unstitchedProducts.length} PRODUCTS</div>
    ...
    <div className="flex p-8"> {/* Flex container for sidebar & products */}
     ...
     <hr/>
      ...
      {unstitchedProducts.map((product) => ( // Use unstitched Products instead of products
            <div 
              key={product.id} 
...
//         setProducts(filteredProducts); // Only show UNSTITCHED products
//       })
