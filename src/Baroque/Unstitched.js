...
//       <div className="text-center font-semibold mx-auto ">44 PRODUCTS</div>
...
// <div><img src="https://baroque.pk/cdn/shop/files/21_f4023488-9f50-433f-bab4-eaf164c65cf0.jpg?v=1733309484&width=600" alt=''/>
// <p className='text-center'>EMBROIDERED NET CH13-01 UNSTITCHED<br/><b>PKR 29,900.00</b><br/>CHANTELLE 13</p></div>
// <div><img src="https://baroque.pk/cdn/shop/files/140_37f9518c-adc6-4858-b402-a8036c9528d0.jpg?v=1734072841&width=600" alt=''/>
// <p className='text-center'>EMBROIDERED NET CH13-01 UNSTITCHED<br/><b>PKR 29,900.00</b><br/>CHANTELLE 13</p></div>
...
//       <ProductList category="unstitched" />
//     </div>
//   );
// };
...
const Unstitched = () => {
  ...
  useEffect(() => {
    fetch("/products.json") // Fetch from public folder
      ...
      .then((data) => {
        const filteredProducts = data.filter((product) => product.category === "unstitched");
