...
const Seperates = () => {
  ...
  // Filter seperates products
  const seperatesProducts = products
    .filter((product) => product.category === "seperates")
    .filter((product) =>
    ...
    <div>
      ...
      <div className="flex h-10 w-full p-1 mb-20 border-t-2 border-b-2">
        <div className="text-center font-semibold mx-auto hidden md:block">
          {seperatesProducts.length} PRODUCTS
        </div>
